...
align_dlib = AlignDlib(os.path.join(os.path.dirname(os.path.realpath('__file__')), 'models', 'shape_predictor_68_face_landmarks.dat'))

def init_pre_proccess(input_dir, output_dir, crop_dim):
